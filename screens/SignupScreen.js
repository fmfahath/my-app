...
import Animated, { FadeIn, FadeInDown, FadeInUp, FadeOut, FadeUp, FadeInRight } from 'react-native-reanimated';
...
export default function SignupScreen() {
    ...
    return (
        <View className='bg-white h-full w-full'>
            ...
            {/* lights */}
            <View className='flex-row justify-around w-full h-full absolute'>
            ...
            {/* title & form */}
            <View className='h-full w-full flex justify-around pt-48 pb-0'>
                {/* title */}
                ...
                <View className='flex items-center mx-4 space-y-4'>
                    ...
                    <Animated.View entering={FadeInDown.delay(800).duration(1000).springify()} className='flex-row justify-center'>
                        ...
                        <TouchableOpacity onPress={() => navigation.push('Login')}>
                            <Text className='text-sky-700 font-bold'>Sign In</Text>
                        </TouchableOpacity>
                    </Animated.View>
                </View>
